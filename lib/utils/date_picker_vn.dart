  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        Solar solar = Solar(
            solarYear: displayedMonth.year,
            solarMonth: displayedMonth.month,
            solarDay: day);
        ...
        var lunarItemStyle = TextStyle(
          fontSize: 10.0,
          color: _lunar.lunarDay == 15 || _lunar.lunarDay == 1 ? themeData.primaryColor : themeData.textTheme.body1.color,
        );
        String lunarValue = _lunar.lunarDay == 1
            ? "${_lunar.lunarDay}/${_lunar.lunarMonth}"
              ...
              child: ExcludeSemantics(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text("$lunarValue", style: lunarItemStyle),
                  ],
                ),
              ),
            ),
